import Vue from 'vue';
import App from './vue/AppFieldInspector.vue';
import store from '@store/fieldInspectorStore';
import VueRouter from 'vue-router';
import routes from '@route/routesFieldInspector';
...
Vue.prototype.$context_name = "app_field_inspector";
Vue.prototype.Route = Vue.prototype.initRouter(router, store).Route;
Vue.prototype.theme = {bgColor: 'linear-gradient(to right, rgb(103, 58, 183), rgb(126, 87, 194))'};
