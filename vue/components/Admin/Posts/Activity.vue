                        ...
                        >
                            ...
                            <template slot="form-top" v-if="formTopState.show">
                                <form class="admin-form-card user-form" @submit.prevent>
                                    <div class="user-form-title">Create new Activity</div>
                                        ...
                                        <div class="form-input-container flex" full>
                                            ...
                                            **For Date and time
                                            ...
                                            <Datetime
                                                ...
                                                zone="Asia/Vientiane"
                                                v-model="models.formTop.activity_date"
                                                input-id="activity_date"
                                                :input-class="'admin-input-datepicker'"
                                            />
                                            <template v-if="validated().activity_date">
                                                <div admin-messages>
                            ...
                            <template slot-scope="{fireEvent, position, rowContent}" slot="form-row-detail">
                                ...
                                <div class="layout-align-space-around-start layout-row">
                                    <div class="form-input-container flex" full>
                                        <label>Activity date</label>
                                        <Datetime
                                            v-model="rowContent.data.activity_date"
                                            @onOpenPopup="onDateTimeOpen"
                                            @close="onDateTimeClose"
                                            value-zone="Asia/Vientiane"
                                            zone="Asia/Vientiane"
                                            ...
                                            :input-class="'admin-input-datepicker'"
                                        />
                                        <template v-if="rowContent.validated.activity_date">
                                            <div admin-messages>
                                                <div admin-message class="message-required ">
                                                    {{ rowContent.validated.activity_date }}
                                                </div>
                                            </div>
                                        </template>
                                    </div>
                                ...
                                >
                                    ...
                                    <button v-if="rowContent.data.status === 'pending'"
                                            @click="manageStatus(fireEvent, rowContent.data, position, 'activity', 'approve')"
    ...
    export default AdminBase.extend({
        ...
        methods: {
                    ...
                    rows: [
                        ...
                        },
                        {
                            ...
                            modal: {
                                ...
                                active: false,
                                type: "warning",
                                message: `When you delete the activity, the activity will be permanently deleted and cannot be un-deleted.`,
                                action: {act: this.postDeleteActivity, text: "Delete"},
                                data: data
                            }
                        }
                    ]
            ...
            positiveAction() {
                ...
                if (action.act) {
                    ...
                    action
                        ...
                        .then(r => {
                            if (r.success) {
                                this.showInfoToast({msg: "The activity was deleted!", dt});
                                this.getItems();
                            } else {
                                this.showErrorToast({
                                    msg: "Failed to delete the activity!",
                                    dt
                                });
                            }
                        })
            ...
            add() {
                ...
                ft.loading = true;
                this.postCreateActivity(this.models.formTop)
                    .then(r => {
                        if (r.success) {
                            this.getItems();
                            ft.show = false;
            ...
            edit(fireEvent, data, position) {
                ...
                data.id = v.data.id;
                this.postUpdateActivity(data)
                    .then(r => {
                        if (r.success) {
                            this.showInfoToast({msg: "The activity was updated!", dt});
                            this.getItems();
                        } else {
                            this.showErrorToast({
